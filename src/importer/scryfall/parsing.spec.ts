...
describe("parsing", () => {
  describe("toCardData", () => {
    describe("single-faced cards", () => {
      it("should transform a normal card", () => {
        ...
        expect(result).toEqual({
          ...
          imageUrlSmall:
            "https://cards.scryfall.io/small/front/8/e/8e88390b.jpg",
          imageUrlNormal:
            "https://cards.scryfall.io/normal/front/8/e/8e88390b.jpg",
          imageUrlLarge:
            "https://cards.scryfall.io/large/front/8/e/8e88390b.jpg",
          oracleText:
            "Breath Weapon deals 2 damage to each non-Dragon creature.",
          printedText: null,
          manaCost: "{2}{R}",
      ...
      it("should transform a localized card with printed fields", () => {
        const card = createMock<ScryfallCard.Any>({
